<?php $__env->startSection('title', 'DIBOO FASHION - الرئيسية'); ?>

<?php $__env->startSection('content'); ?>
    <section class="hero-section text-center">
        <div class="container">
            <div class="hero-logo animate-on-scroll">
                <img src="<?php echo e(asset('images/image.png')); ?>" alt="DIBOO FASHION Logo" class="hero-logo-img">
            </div>
            ...
            <a href="<?php echo e(url('products')); ?>" class="btn btn-custom btn-lg animate-on-scroll">تسوق الآن</a>
        </div>
    </section>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\course\BackEnd\xamp\htdocs\DIBOO\diboo\resources\views\pages\index.blade.php ENDPATH**/ ?>