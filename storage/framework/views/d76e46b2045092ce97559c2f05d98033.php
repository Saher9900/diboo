<?php $__env->startSection('title', 'DIBOO FASHION - من نحن'); ?>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4">
                    <div class="about-image animate-on-scroll">
                        <img src="<?php echo e(asset('images/image.png')); ?>" alt="DIBOO FASHION" class="about-img">
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\course\BackEnd\xamp\htdocs\DIBOO\diboo\resources\views\pages\about.blade.php ENDPATH**/ ?>